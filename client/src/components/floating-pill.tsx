            ...
            {isVisible && (
                <div className="fixed top-6 left-0 right-0 z-50 flex justify-center pointer-events-none px-4">
                    <motion.div
                        ...
                        className={`pointer-events-auto flex items-center bg-background/80 backdrop-blur-xl border border-white/10 shadow-2xl transition-all duration-300 relative ${isCollapsed
                            ? "rounded-full p-3 hover:bg-background/90 cursor-pointer w-auto justify-center absolute right-0 mr-4 sm:mr-6"
                            : "w-fit max-w-full rounded-full px-4 py-2.5 justify-center overflow-hidden"
                            }`}
                    >
                        {isCollapsed ? (
                            <div
